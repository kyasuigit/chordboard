...
void drum_widget::on_pushButton_clicked(){
    if (openOrClosed == false){
        QSound::play(":/drum/assets/closed_hihat.wav");
        if (recording){
        ...
        QSound::play(":/drum/assets/open_hihat.wav");
...
void drum_widget::on_pushButton_4_clicked(){
    QSound::play(":/drum/assets/ride_cymbal.wav");
    if (recording){
...
void drum_widget::on_pushButton_7_clicked(){
    QSound::play(":/drum/assets/floor_tom.wav");
    if (recording){
...
void drum_widget::on_pushButton_8_clicked(){
    QSound::play(":/drum/assets/bass_drum.wav");
    if (recording){
