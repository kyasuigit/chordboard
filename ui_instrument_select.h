...
public:
    ...
    {
        instrument_select->setWindowTitle(QApplication::translate("instrument_select", "instrument_select", 0));
        selectLabel->setText(QApplication::translate("instrument_select", "Select an Instrument to Change to:", 0));
    } // retranslateUi
